		...
		return a(this)
				.each(
						function() {
							...
							if (m.ui) {
								var f = a('<div class="stepper-btn-wrap"/>')
										.appendTo(p), j = a(
										'<a class="stepper-btn-up">'
												+ m.incrementButton + "</a>")
										.appendTo(f), o = a(
										'<a class="stepper-btn-dwn">'
												+ m.decrementButton + "</a>")
										.appendTo(f);
								p.css({
									...
									"margin-right" : f.outerWidth()
											+ parseInt(k.css("margin-right"))
								});
								k.css("margin", 0);
								var e;
							...
							function n(q) {
								...
								var s = m.type == "int" ? parseInt : parseFloat, r = i(s(k
										.val())
										+ q);
								k.val(r);
								d("Step", [ r, q > 0 ]);
